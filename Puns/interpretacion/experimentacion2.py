...
if len(sys.argv) != 3:
	print ("Uso: python3 experimentacion2.py <fichero_xml> <fichero_out>")
	sys.exit(1)
...
for k in distancias_coseno_frases:
    if k in distancias_metrica_sentidos_frases:
        pun = puns[k]
        ...
        p2 = distancias_metrica_sentidos_ord[0][1]
        if p1 == p2:
            p2 = distancias_metrica_sentidos_ord[1][1]
