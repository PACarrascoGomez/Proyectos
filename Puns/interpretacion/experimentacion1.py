...
if len(sys.argv) != 3:
	print ("Uso: python3 experimentacion1.py <fichero_xml> <fichero_out>")
	sys.exit(1)
...
# Obtenemos las distancia de las palabras de la sentencia respecto al pun
distancias_frases = {}
for k in frases_tok:
    pun = puns[k]
...
for k in distancias_frases:
	pun = puns[k]
	distancias = distancias_frases[k]
	distancias_ord = sorted(distancias)
	p1 = distancias_ord[0][1]
	p2 = distancias_ord[1][1]
