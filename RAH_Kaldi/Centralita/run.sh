...
# Creamos los enlaces simbolicos de las herramientas de kaldi
ln -s ../wsj/s5/utils/
ln -s ../wsj/s5/steps

# Copiamos el fichero para obtener los scores
...
echo "Preparando datos de lenguaje..."
./preparar_lenguaje.sh
